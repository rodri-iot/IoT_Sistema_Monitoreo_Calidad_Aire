...
const NUM_READINGS = parseInt(process.env.NUM_READINGS) || 10
...
const SENSOR_ID = process.env.SENSOR_ID || 'esp32-air-002'

// Certificados (el ESP32 usaría certificados específicos, aquí usamos uno genérico)
const DEVICE_ID = process.env.DEVICE_ID || 'nodo02'
 ...
 */
function generateReading(sensorId, sensorType = 'advanced') {
